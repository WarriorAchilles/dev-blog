...
Dedicated Fullstack Software Engineer with 3+ years of experience in the ecommerce space. I help software companies and enterprise brands ship quality products at scale, focusing on responsive frontend web applications on using React, TypeScript, and Next and efficient backend systems using Node.js and AWS.
