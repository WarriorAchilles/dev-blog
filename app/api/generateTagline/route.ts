        ...
        const chatResponse = await openai.chat.completions.create({
            ...
            messages: [
                ...
                },
                {
                    role: 'user',
                    content:
                        'Write a single 6-8 word, first-person, funny portfolio headline. Casual, dev-core tone. No buzzwords. Randomly mention things like snacks, matcha, zen, dark mode, or similar things. No clean code, legacy code, ninja, or wizard.',
                },
            ],
            max_tokens: 40,
        });
