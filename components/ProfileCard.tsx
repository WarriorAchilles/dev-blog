...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    avatarImageName = '<Placeholder for avatar URL>',
    ...
    const avatarUrl = '/static/images/' + avatarImageName;
    const miniAvatarUrl = '/static/images/' + miniAvatarImageName;
