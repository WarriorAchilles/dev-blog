        ...
        <>
            <div className="container mb-3 flex h-[80vh] flex-col items-center justify-center">
                <div className="container flex w-full flex-col items-center justify-center pb-30">
                    ...
                    <a
                        className="text-textHeading glass3d m-2 max-w-1/2 rounded-full"
                        href="/portfolio"
                    >
                        <GlareHover
                            glareColor="#ffffff"
                ...
                <div className="container flex flex-col items-center md:flex-row">
                    ...
                    <button
                        className="text-textHeading glass3d flex w-[200px] items-center justify-evenly rounded-full text-wrap transition hover:bg-transparent focus:bg-transparent sm:text-nowrap"
