        ...
        <>
            <div className="container mb-3 flex h-[80vh] flex-col items-center justify-center">
                <div className="container flex w-full flex-col items-center justify-center pb-30">
                    ...
                    <a
                        className="bg-koi dark:bg-sky dark:hover:text-sky text-textBody-light dark:text-surface border-koi dark:border-sky m-2 max-w-1/2 rounded-full border-2 px-3 py-2 transition hover:bg-transparent"
                        href="/portfolio"
                    >
                        My projects
                    </a>
                ...
                <div className="flex flex-col items-center justify-center md:flex-row">
                    <p className="text-textBody-light dark:text-textBody mb-5 w-3/4 text-sm md:mr-5 md:mb-0">
                    ...
                    <button
                        className="bg-koi dark:bg-sky dark:hover:text-sky text-textBody-light dark:text-surface border-koi dark:border-sky max-w-1/2 min-w-1/4 rounded-full border-2 px-3 py-2 text-wrap transition hover:bg-transparent sm:text-nowrap"
                        onClick={fetchTagline}
                        disabled={loading}
                    >
                        {loading ? 'Generating...' : 'Generate new tagline'}
                    </button>
                </div>
                <Image
